...
SELECT DISTINCT
    ...
    'Apr: ' ||TO_CHAR(ELABI.DT_APROVACAO,'hh24:mi')                AS DT_APROVACAO
...
AND ELABI.DT_DIGITACAO >= SYSDATE - INTERVAL '3' MINUTE -- Pega exames digitados nos últimos 5 mi
--AND ELABI.DT_DIGITACAO >= SYSDATE - INTERVAL '16' HOUR -- Pega exames digitados nas últimas 24 horas
AND (
    CASE
