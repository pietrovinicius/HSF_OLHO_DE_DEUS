...
AND ELABI.DT_DIGITACAO >= SYSDATE - INTERVAL '58' MINUTE -- Pega exames digitados nos últimos 5 mi
--AND ELABI.DT_DIGITACAO >= SYSDATE - INTERVAL '1' HOUR -- Pega exames digitados nas últimas 24 horas
